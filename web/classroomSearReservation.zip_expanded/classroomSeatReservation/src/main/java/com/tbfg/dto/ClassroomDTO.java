...
public class ClassroomDTO {
    ...
    public int getClassroomNull() { 
        return classroomNull;
    }

    public void setClassroomNull(int classroomNull) { 
        this.classroomNull = classroomNull;
    }
