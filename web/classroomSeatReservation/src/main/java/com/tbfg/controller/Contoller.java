...
public class Contoller {
	...
	public String getClassroomStatus(HttpServletRequest request, HttpSession session, Model model) {
		...
		if (classroomDTO.getClassroomNull() == 1) {
			System.out.println(
					"classroomDTO.getClassroomNull(1)3 classroomStatusGet : " + classroomDTO.getClassroomNull());
	...
	public String classroomStatus(@RequestParam("classroomName") String classroomName,
		...
		System.out.println("classroomDTO.getClassroomNull(1)1 classroomStatus: " + classroomDTO.getClassroomNull());
		if (classroomDTO.getClassroomNull() == 0) {
			System.out.println("classroomDTO.getClassroomNull(1)5 classroomStatus: " + classroomDTO.getClassroomNull());
			return "redirect:/timetable";
		}
	...
	public String reserveSeat(String classroomName, Integer seatNumber, String day, String subject, HttpSession session,
		...
		classroomDTO.setClassroomNull(0);
		System.out.println("classroomDTO.getClassroomNull(1)2 reserveSeat : " + classroomDTO.getClassroomNull());
	...
	public String banSeat(String classroomName, Integer seatNumber, HttpSession session, Model model)
		...
		classroomDTO.setClassroomNull(0);
		System.out.println("classroomDTO.getClassroomNull(1)2 banSeat : " + classroomDTO.getClassroomNull());
	...
	public String cancelReservation(@RequestParam("reservNum") int reservNum, // 요청 파라미터로 전달된 예약 번호
	...
	public String updateReservation(@RequestParam("reservNum") int reservNum, // 요청 파라미터로 전달된 예약 번호
	...
	public String showClassroomInfo(@RequestParam String classroomName, Model model, HttpSession session) {
		...
		if (reserveList == null || reserveList.isEmpty()) {
			...
			for (Map.Entry<Integer, List<ReserveList>> entry : groupedReservations.entrySet()) {
				String times = entry.getValue().stream().map(reservation -> String.valueOf(reservation.getReservHour()))
	...
	public String timetable(HttpSession session, Model model, @ModelAttribute("warning") String warning) {
		...
		System.out.println("classroomDTO.getClassroomNull(2);timetable : " + classroomDTO.getClassroomNull());
		classroomDTO.setClassroomNull(1);
		System.out.println("classroomDTO.getClassroomNull(1);timetable : " + classroomDTO.getClassroomNull());
